...
prepare_verification_candidate() {
  ...
  /usr/bin/plutil -insert gates.manualAccessibility -string notExecuted \
    "$VERIFICATION_CANDIDATE" || return 1
  for gate in iOSSafari androidChrome macOS26Lifecycle macOS27Lifecycle; do
